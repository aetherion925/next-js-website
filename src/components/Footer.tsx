        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transforming ideas into powerful digital solutions through innovative technology and expert craftsmanship.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/company/aetherion"
                target="_blank"
              ...
              <a
                href="https://twitter.com/aetherion"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://github.com/aetherion925"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://instagram.com/aetherion"
                target="_blank"
                rel="noopener noreferrer"
