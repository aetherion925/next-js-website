        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/aetherion-ofc-235668387"
                target="_blank"
              ...
              <a
                href="https://x.com/aetherion_ofc"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/aetherion_ofc/"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="text-gray-300 text-sm md:text-right">
              <p>
                &copy; {new Date().getFullYear()} Aetherion. All rights
                reserved.
              </p>
            </div>
          </div>
